...
task.spawn(function()
    local repo = 'https://raw.githubusercontent.com/AZparcero/LinoriaLib-Mobile/main/'
...
local Window = Library:CreateWindow({ Title='Rivals Hub', Center=true, AutoShow=true })
local Tabs = {
